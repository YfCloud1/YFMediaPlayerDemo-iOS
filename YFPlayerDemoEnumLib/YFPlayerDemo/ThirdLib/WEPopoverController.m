		...
		if (animated) {
            ...
            [UIView animateWithDuration:FADE_DURATION
                             ...
                             animations:^{
                                 ...
                                 NSNumber * number = [NSNumber numberWithBool:userInitiated];
                                 [self animationDidStop:@"FadeOut" finished:[NSNumber numberWithBool:finished] context:(__bridge void *)number];
                             }];
